        ...
        <div className="pt-20 md:pt-24 pb-12 px-4 md:px-6 min-h-screen max-w-xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-4">
            <div className="p-6 text-center">
              ...
              <h2 className="text-lg font-semibold text-gray-900 mb-2">How to Deposit</h2>
              <p className="text-sm text-gray-600 mb-4">
                To deposit funds into your account, please contact our support team with your deposit details
              </p>
            </div>
          </div>
