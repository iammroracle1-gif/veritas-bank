      ...
      <main className="flex-1 lg:ml-72 overflow-auto bg-gray-50">
        ...
        <div className="pt-20 md:pt-24 pb-12 px-4 md:px-6 min-h-screen max-w-xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-1">Request a withdrawal</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-4">
            <div className="p-6 text-center">
              ...
              <h2 className="text-lg font-semibold text-gray-900 mb-2">How to Withdraw</h2>
              <p className="text-sm text-gray-600 mb-4">
                To withdraw funds from your account, please contact our support team with your withdrawal request
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
            <div className="px-4 py-3 border-b border-gray-100">
              <h3 className="text-xs font-medium text-gray-500 uppercase tracking-wide">Contact Support</h3>
            </div>
            <div className="divide-y divide-gray-100">
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">support@veritasbank.com</p>
                </div>
