              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900 font-medium">support@veritasbank.com</p>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-sm">
            ...
            <div className="divide-y divide-gray-100">
              <div className="px-6 py-4">
                <p className="text-sm font-medium text-gray-900 mb-2">How do I deposit funds?</p>
                <p className="text-sm text-gray-500">Contact our support team via email or WhatsApp to initiate a deposit to your account.</p>
              </div>
              <div className="px-6 py-4">
                <p className="text-sm font-medium text-gray-900 mb-2">How do I withdraw funds?</p>
                <p className="text-sm text-gray-500">Reach out to support with your withdrawal request and account details.</p>
              </div>
              <div className="px-6 py-4">
                <p className="text-sm font-medium text-gray-900 mb-2">What if I forgot my PIN?</p>
                <p className="text-sm text-gray-500">Go to Settings to reset your transaction PIN.</p>
              </div>
            </div>
          </div>
        </div>
